...
The system leverages unsupervised **Clustering** model and an integrated **Reinforcement Learning (RL) loop** to refine recommendations based on user interactions (likes), creating a personalized and adaptive shopping experience.
...
3. **Recommendation Engine (`app.py`)**:
...
## About Data
the data was collected by scraping bot I made that scrape data from real products in Digital category of Digikala.com
